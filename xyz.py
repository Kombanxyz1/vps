...
TOKEN = '6432488865:AAHoWpIfhMm495CM7pNW_SIS9nYpiWKf2rQ'
...
FORWARD_CHANNEL_ID = -1002092537066
CHANNEL_ID = -1002092537066
error_channel_id = -1002092537066
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/c/2092537066/1347*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*@xYz_CriminalL*", parse_mode='Markdown')
    else:
